 ...
 * @author iPeer
 */
public class CommandAddYouTubeUser extends Command {
    
    public CommandAddYouTubeUser() {
	registerAliases("addyoutubeuser");
    }
	...
	try {
	    if (engine.getAnnouncers().get("YouTube").addYTUser(user, true))
